  ...
  return (
    <div className="mt-4">
      ...
      <label className="block mb-2">
        ...
        <input type="text" className="bg-gray-800 text-white p-2 rounded w-full" placeholder="Enter your AppKit Project ID" />
      </label>
      <label className="block">
        <span className="text-sm">Custom RPC:</span>
        <input type="text" className="bg-gray-800 text-white p-2 rounded w-full" placeholder="https://rpc.reown.com" />
      </label>
    </div>
  );
};
